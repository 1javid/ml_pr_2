...
\author{Javid Alakbarli \and Nifdi Guliyev}
\date{February 2026}
...
\begin{table}[h]
\centering
\caption{Contribution of team members.}
\begin{tabularx}{1.0\linewidth}{|l|X|}
\hline
\textbf{Team Member} & \textbf{Contributions} \\
\hline
Javid Alakbarli & EDA; Binary \& Multinomial Logistic Regression; Application \\
\hline
Nifdi Guliyev   & LDA \& QDA; Naïve Bayes; Poisson Regression; Application \\
\hline
\end{tabularx}
\end{table}
